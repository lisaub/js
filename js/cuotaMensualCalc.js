function cuotaMensualCalc(fechaActualDate, montoPrestamo, meses, tasaInteres, detallesCuotas) {
  ...
  while (mes <= meses) {
    ...
    const fechaCuota = new Date(fechaActualDate.getFullYear(), fechaActualDate.getMonth() + mes, fechaActualDate.getDate());
